...
(defun get-hex-or-term (n)
  ...
  (cond ((eq n 0)  (if (display-graphic-p) "#242a2c"  "black"))
        ((eq n 1)  (if (display-graphic-p) "#C29A61"  "red"))
        ((eq n 2)  (if (display-graphic-p) "#7D8482"  "green"))
        ((eq n 3)  (if (display-graphic-p) "#90958E"  "yellow"))
        ((eq n 4)  (if (display-graphic-p) "#B5BBB9"  "blue"))
        ((eq n 5)  (if (display-graphic-p) "#C3BCB1"  "magenta"))
        ((eq n 6)  (if (display-graphic-p) "#BDC1BE"  "cyan"))
        ((eq n 7)  (if (display-graphic-p) "#d6d7d7"  "white"))
        ((eq n 8)  (if (display-graphic-p) "#959696"  "brightblack"))
        ((eq n 9)  (if (display-graphic-p) "#C29A61"  "brightred"))
        ((eq n 10) (if (display-graphic-p) "#7D8482" "brightgreen"))
        ((eq n 11) (if (display-graphic-p) "#90958E" "brightyellow"))
        ((eq n 12) (if (display-graphic-p) "#B5BBB9" "brightblue"))
        ((eq n 13) (if (display-graphic-p) "#C3BCB1" "brightmagenta"))
        ((eq n 14) (if (display-graphic-p) "#BDC1BE" "brightcyan"))
        ((eq n 15) (if (display-graphic-p) "#d6d7d7" "brightwhite"))))
